                ...
                <form class="mt-5" action="{{ route('manage.store') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                            id="floatingInput" placeholder="Dune" value="{{ old('title') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="author" class="form-control @error('author') is-invalid @enderror"
                            id="floatingInput" placeholder="Frank Herbert" value="{{ old('author') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" name="pages" class="form-control @error('pages') is-invalid @enderror"
                            id="floatingInput" placeholder="0" value="{{ old('pages') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" name="release_year"
                            ...
                            placeholder="2012" value="{{ old('release_year') }}">
